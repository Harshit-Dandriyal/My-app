  ...
  const chatVisibility = () => {
    if (
      selectedChat?.users?.find(
        (usersOfGroup) => user.email === usersOfGroup.email
      )
    ) {
          ...
          >
            {loading ? (
              ...
              <div className="messages">
                {chatVisibile ? <ScrollableChat messages={messages} /> : <></>}
              </div>
            )}
            {chatVisibile ? (
              <FormControl
              ...
              <>
                <p>You cannot send message without joining</p>
                <Button onClick={() => handleAddUser(user)} colorScheme="green">
                  Join Group
                </Button>
              </>
            )}
